// 📦 Namespace (espacio de nombres) donde vive la clase.
...
namespace Dominio.Entities
{
    ...
    public class Product
    {
        ...
        public string Name
        {
            ...
            set
            {
                // ⚠️ Validación: el valor no puede ser nulo ni vacío.
                // 🟠 CORRECCIÓN: aquí debería usarse 'value', no '_name'.
        ...
        public decimal Price
        {
            ...
            set
            {
                // ⚠️ Validación: el precio no puede ser negativo.
                if (value < 0)
                {
        ...
        // 🏗️ Constructor de la clase Product.
        // Recibe los valores iniciales para Id, Name y Price.
        public Product(Guid id, string name, decimal price)
        {
            // ⚠️ CORRECCIÓN: aquí se debe usar 'Id = id;', no 'id = id;'.
            // La asignación actual no tiene efecto.
            Id = id;
